    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.META.get('HTTP_ACCEPT') == 'application/json':
            ...
            for post_object in posts:
                post_dict_list.append(self.getPostDict(post_object))
...
class PostResource(BaseView):
    ...
    def getPostDict(self, post_object):
        ...
        author_dict = self.getAuthorDict(post_object.author, include_url=True)
        ...
        comment_dict_list = self.getCommentDictList(comment_list)
        print comment_dict_list
        post_dict["comments"] = comment_dict_list

        return post_dict

    def getCommentDictList(self, comment_list):
        ...
        for comment in comment_list:
            comment_dict = {}
            comment_dict["author"] = self.getAuthorDict(comment.user)
    ...
    def getAuthorDict(self, author_object, include_url=False):
